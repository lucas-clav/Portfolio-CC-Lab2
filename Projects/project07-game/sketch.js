const PROJECT_PATH = "Projects/project07-game/";
...
//—————PRELOAD—————
function preload() {
  alarmFont = loadFont(PROJECT_PATH + "ds-digi.ttf");
  alarmTextFontBox1 = loadFont(PROJECT_PATH + "text_font.ttf");
  alarmSound = loadSound(PROJECT_PATH + "alarm_sound.mp3");

  // Looping Images (Room Imgs)
  for (let i = 1; i <= 16; i++) {
    roomImgs.push(loadImage(PROJECT_PATH + nf(i, 2) + ".png"));
  }
  
  // Looping Images (Kitchen 1 Imgs)
  for (let i = 1; i <= 16; i++) {
    let filename = nf(i, 2) + ".png";
    kitchen1imgs.push(loadImage(PROJECT_PATH + filename));
  }
  
  // Looping Images (Kitchen 2 Imgs)
  for (let i = 1; i <= 16; i++) {
    let filename = nf(i, 2) + ".png";
    kitchen2imgs.push(loadImage(PROJECT_PATH + filename));
  }
  
  // Looping Images (Kitchen 3 Imgs)
  for (let i = 1; i <= 16; i++) {
    let filename = nf(i, 2) + ".png";
    kitchen3imgs.push(loadImage(PROJECT_PATH + filename));
  }
  
  // Single Asset Loads
  roomFloor = loadImage(PROJECT_PATH + "floor_room.jpg");
  roomPainting = loadImage(PROJECT_PATH + "painting.jpg");
  netImg = loadImage(PROJECT_PATH + "net.png");
  boatImg = loadImage(PROJECT_PATH + "boat.png");
  scene1Font = loadFont(PROJECT_PATH + "text_font.ttf");
  cooking1Sound = loadSound(PROJECT_PATH + "cooking_sound.mp3");
  cooking1SarImg = loadImage(PROJECT_PATH + "sardines.png");
  cooking1SteImg = loadImage(PROJECT_PATH + "steam.png");
  cooking1Font = loadFont(PROJECT_PATH + "text_font.ttf");
  kitchen1floor = loadImage(PROJECT_PATH + "floor_kitchen.jpg");
  kitchen1img = loadImage(PROJECT_PATH + "kitchen_asset.png");
  kitchen1signFont = loadFont(PROJECT_PATH + "sign_font.ttf");
  kitchen1clockFont = loadFont(PROJECT_PATH + "ds-digi.ttf");
  kitchen1textFont = loadFont(PROJECT_PATH + "text_font.ttf");
  unImg = loadImage(PROJECT_PATH + "union_square.png");
  coImg = loadImage(PROJECT_PATH + "corn.png");
  toImg = loadImage(PROJECT_PATH + "tomato_icon.png");
  ceImg = loadImage(PROJECT_PATH + "cebolla_larga.png");
  poImg = loadImage(PROJECT_PATH + "potato.png");
  scene2Font = loadFont(PROJECT_PATH + "text_font.ttf");
  moneyImg = loadImage(PROJECT_PATH + "money_icon.png");
  cooking2Sound = loadSound(PROJECT_PATH + "cooking_sound.mp3");
  cooking2ContinueFont = loadFont(PROJECT_PATH + "text_font.ttf");
  cooking2FigImg = loadImage(PROJECT_PATH + "empanadas.png");
  cooking2SteImg = loadImage(PROJECT_PATH + "steam.png");
  kitchen2floor = loadImage(PROJECT_PATH + "floor_kitchen.jpg");
  kitchen2img = loadImage(PROJECT_PATH + "kitchen_asset.png");
  kitchen2signFont = loadFont(PROJECT_PATH + "sign_font.ttf");
  kitchen2clockFont = loadFont(PROJECT_PATH + "ds-digi.ttf");
  kitchen2textFont = loadFont(PROJECT_PATH + "text_font.ttf");
  treeImg = loadImage(PROJECT_PATH + "fig_tree.png");
  baskImg = loadImage(PROJECT_PATH + "basket.png");
  scene3Font = loadFont(PROJECT_PATH + "text_font.ttf");
  figImg = loadImage(PROJECT_PATH + "fig.png");
  cooking3Sound = loadSound(PROJECT_PATH + "cooking_sound.mp3");
  cooking3Font = loadFont(PROJECT_PATH + "text_font.ttf");
  cooking3figImg = loadImage(PROJECT_PATH + "fig_tart.png");
  cooking3SteImg = loadImage(PROJECT_PATH + "steam.png");
  kitchen3floor = loadImage(PROJECT_PATH + "floor_kitchen.jpg");
  kitchen3img = loadImage(PROJECT_PATH + "kitchen_asset.png");
  kitchen3signFont = loadFont(PROJECT_PATH + "sign_font.ttf");
  kitchen3clockFont = loadFont(PROJECT_PATH + "ds-digi.ttf");
  kitchen3textFont = loadFont(PROJECT_PATH + "text_font.ttf");
}
